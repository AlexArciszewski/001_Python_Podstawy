...
class Note:
    ...
    def __init__(self, author:str, memo_content:str, message_date:date,note:list) -> None:
        self.author = author
...
class Notebook:
    def __init__(self,notebook:list) -> None:
        self.notebook = []
        
    
    def add_new_note_to_notebook(self, note:'Note'):
