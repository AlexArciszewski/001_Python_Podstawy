...
class Workshops:
    ...
    def add_participant(self, name: str, surname: str, status:int):
        self.name = name
        self.surname = surname
        self.status = status     
        participant = {}
        ...
        for _ in range(3):
            ...
            self.status = input("choose s for student and i for instructor")
...
def main():
    ...
    workshop_001.add_participant("Chackie","Chan","s")
