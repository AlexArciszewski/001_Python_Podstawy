class Character:
    def __init__(self, name, start_items, abilities_):
        ...
        self.hp = 100
        self.gold = 50
        self.inventory = start_items #lista dla itemów w inventory
...
class Elf(Character):
    def __init__(self,name):
        super().__init__(name,["bow", "knife"], {"shooting" :"just shot a bow...","attack":"just attacked enemy with knife..."})
